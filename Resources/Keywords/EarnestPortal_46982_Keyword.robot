...
CONVERTING DATE FROM WORDS TO NUMBERS
    ${week_date_range}          Get Text                ${ep46982_thisweek_form}
...
SELECTING SPECIFIC DATE RANGE
    [Arguments]     ${date_range_to_click}     ${affected_element_of_changing_option}       ${expected_string}
    Wait Until Element Is Visible       ${ep46982_daterange_form}                   ${wait_mid}
    Click Element                       ${ep46982_daterange_form}
    Wait Until Element Is Visible       ${date_range_to_click}                      ${wait_mid}
    Click Element                       ${date_range_to_click}
    Sleep    1s
    Scroll Element Into View            ${affected_element_of_changing_option}
    Wait Until Element Is Visible       ${affected_element_of_changing_option}      ${wait_mid}
    ${total_registered_user_vsperiod_val}       Get Text        ${affected_element_of_changing_option}
#    ${total_registered_user_vsperiod_val}       Split String    ${total_registered_user_vsperiod_val}
    ${total_registered_user_vsperiod_val}       Remove String    ${total_registered_user_vsperiod_val}      vs${SPACE}
    Should Be Equal As Strings          ${total_registered_user_vsperiod_val}    ${expected_string}
